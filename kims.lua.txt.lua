...
function Library:CreateWindow(config)
    ...
    -- ====== HEADER TENGAH: LOGO + KIMS + Fish It ======
    -- Container untuk elemen tengah, memberi ruang untuk tombol minimize di kanan
