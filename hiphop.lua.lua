...
-- Konfigurasi folder & file (ubah nama menjadi Kims)
local CONFIG_FOLDER    = "KimsGUI_Configs"
local CONFIG_FILE      = CONFIG_FOLDER .. "/kims_config.json"
local CurrentConfig    = {}
local DefaultConfig    = {}
local isDirty          = false
...
-- Warna: primary MERAH, background merah gelap
local colors = {
    primary = Color3.fromRGB(200, 30, 30),        -- merah
    secondary = Color3.fromRGB(180, 50, 50),
    accent = Color3.fromRGB(220, 60, 60),
    success = Color3.fromRGB(34, 197, 94),
    bg1 = Color3.fromRGB(30, 8, 8),              -- background merah gelap
    bg2 = Color3.fromRGB(50, 15, 15),
    bg3 = Color3.fromRGB(70, 25, 25),
    bg4 = Color3.fromRGB(90, 35, 35),
...
local headerHeight = 72 -- diperbesar untuk logo besar (3x lipat)
...
function Library:CreateWindow(config)
    ...
    -- ====== HEADER TENGAH: LOGO BESAR (3x lipat) + KIMS + Fish It ======
    local headerCenter = new("Frame", {
        Parent = scriptHeader,
        Size = UDim2.new(1, -34, 1, 0), -- -34 untuk tombol minimize (22) + padding
        Position = UDim2.new(0, 0, 0, 0),
        BackgroundTransparency = 1,
        ZIndex = 6
    })

    -- Logo (asset 71905474009889) ukuran 60x60 (3x lipat)
    local logo = new("ImageLabel", {
        Parent = headerCenter,
        Image = "rbxassetid://71905474009889",
        Size = UDim2.new(0, 60, 0, 60),
        Position = UDim2.new(0, 4, 0.5, -30),
        BackgroundTransparency = 1,
        ZIndex = 7
    })

    -- Teks "KIMS" (besar, di tengah)
    local titleLabel = new("TextLabel", {
        Parent = headerCenter,
        Text = "KIMS",
        Size = UDim2.new(0, 120, 0, 24),
        Position = UDim2.new(0.5, -60, 0, 6),
        BackgroundTransparency = 1,
    ...
    -- Teks "Fish It" (kecil, di bawah KIMS)
    ...
    -- Tombol minimize (tetap di kanan)
    ...
    local minLine = new("Frame", {
        Parent = btnMinHeader,
        Size = UDim2.new(0, 14, 0, 2.5),
        Position = UDim2.new(0.5, -7, 0.5, -1.25),
        BackgroundColor3 = colors.primary,
        BorderSizePixel = 0,
        ZIndex = 8
    })
    ...
    local function setMinimizeHover(hovering)
        ...
        minLine.Size = hovering and UDim2.new(0, 16, 0, 2.5) or UDim2.new(0, 14, 0, 2.5)
        minLine.Position = hovering and UDim2.new(0.5, -8, 0.5, -1.25) or UDim2.new(0.5, -7, 0.5, -1.25)
    end
    ...
    -- Hapus bagian Discord (sudah tidak ada)
    ...
    local minimizedIconSize = 60 -- ikuti ukuran logo besar
...
-- Fungsi search bar (tidak diubah)
